...
function createPDF() {
    ...
    const cardsPerPage = parseInt(document.getElementById('cards-per-page').value);
    ...
    for (let i = 0; i < pairs.length; i += cardsPerPage) {
        ...
        // Spanish (back) page - column swap for perfect double-sided printing
        let swapped = [];
        const cols = 2;
...
function downloadPDF() {
    ...
    status.innerHTML = `🎉 Downloaded! Print double-sided → Flip on short edge`;
